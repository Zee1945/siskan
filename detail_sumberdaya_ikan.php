                ...
                <div class="row mt-5 mr-4">
                    ...
                    <div class="col-md-6">
                        <div class="card shadow">
                            <div class="card-header d-flex justify-content text-center">
                                <h4><?php echo $data['nama_indonesia']?></h4>&nbsp;<p>
                                    (<i><?php echo $data['nama_ilmiah']?></i>)</p>
                            </div>
                            <div class="card-body mt-3">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-6" style="padding-left: 20px;">
                                                <h4><?php echo $data['kategori']?></h4>
                                            </div>
                                            <div class="col-md-6 text-center d-flex" style="padding-left: 20px;">
                                                <h4><?php echo number_format($data['produksi'],2,',','.'); ?> </h4>
                                                &nbsp; <h5><?php echo $data['satuan_produksi']?> </h5>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-6" style="padding-left: 20px;">
                                                <h4>Rp. <?php echo number_format($data['nilai'],2,',','.')?></h4>
                                            </div>
                                            <div class="col-md-6" style="padding-left: 20px;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">Tahun</div>
                                            <div class="col-md-6">Musim Ikan</div>
                                        </div>
                                        <div class="row mb-4">
                                            <div class="col-md-6" style="padding-left: 20px;">
                                                <h4><?php echo $data['tahun']?></h4>
                                            ...
                                            <div class="col-md-6" style="padding-left: 20px;">
                                                <h4><?php echo $data['musim_ikan']?></h4>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12 text-center card-header rounded">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text"><?php echo $data['tingkah_laku']?>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="row mt-4    ">
                        <div class="col-md-12 text-center">
                            <a href="sumberdaya_ikan.php">Back to menu</a>
                        </div>
                    </div>
