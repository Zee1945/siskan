...
$result = mysqli_query($mysqli, "SELECT * FROM sarana_prasarana WHERE id = $id");
                    ...
                    <div class="col-md-12">
                        <div class="card shadow">
                            <div class="card-header">
                                <h3>Edit Sarana dan Prasarana</h3>
                            </div>
                            <div class="card-body mt-3">
                             ...
                             while($data = mysqli_fetch_array($result)) {  ?>
                                    <form action="update_sarana_prasarana.php" method="post">
                                        <input type="hidden" name="id" value="<?php echo $data['ID'] ?>">
                                        <div class="row mb-4">
                                            <div class="col-md-3"></div>
                                            <div class="col-md-7 me-auto">
                                                <img src="/siskan/assets/img/sarana/<?php echo $data['image']?>" alt="belum ada gambar">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-7 me-auto">
                                                <input type="text" class="form-control" name="nama-sarana"
                                                    value="<?php echo $data['nama_sarana']?>">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <div class="col-md-3">Jumlah : </div>
                                            <div class="col-md-7 me-auto">
                                                <input type="text" class="form-control" nama="jumlah"
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-7 me-auto">
                                                <input type="text" class="form-control" name="jenis-sarana"
                                                    value="<?php echo $data['jenis_sarana']?>">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                        ...
                                        <div class="row mb-4 mt-4">
                                            <div class="col-md-3 ms-auto">
                                                <input class="btn btn-success btn-lg" type="submit" value="Simpan Perubahan">
                                            </div>
